...
PARAMETERS package TYPE tadir-devclass DEFAULT 'Z2_'.

PARAMETERS : yes_intf RADIOBUTTON GROUP rad1,
             no_intf  RADIOBUTTON GROUP rad1 DEFAULT 'X'.
...
PARAMETERS: trnsport TYPE sxco_transport OBLIGATORY.
